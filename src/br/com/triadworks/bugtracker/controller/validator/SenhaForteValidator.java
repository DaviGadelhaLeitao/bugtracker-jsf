...
public class SenhaForteValidator implements Validator {
	...
	public void validate(FacesContext ctx, UIComponent component, Object value)
		...
		if (!valor.contains("@")) {
			throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "O campo senha"
					+ " não é forte o bastante", "A senha deve ter de 6 a 20 catacteres e deve conter números"));
		}
	}
}
