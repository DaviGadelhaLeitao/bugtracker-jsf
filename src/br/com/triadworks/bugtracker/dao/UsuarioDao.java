...
public class UsuarioDao {
	...
	public void adiciona(Usuario usuario) {
		...
		try {
			...
			transaction.commit();
			new FacesUtil().adicionaMensagemSucesso("Usuário adicionado com sucesso.");
		} catch (Exception e) {
	...
	public void atualiza(Usuario usuario) {
		...
		try {
			...
			transaction.commit();
			new FacesUtil().adicionaMensagemSucesso("Usuário alterado com sucesso.");
		} catch (Exception e) {
			if (transaction.isActive()) {
				transaction.rollback();
			}
	...
	public void remove(Usuario usuario) {
		...
		try {
			...
			transaction.commit();
			new FacesUtil().adicionaMensagemSucesso("Usuário removido com sucesso.");
		} catch (Exception e) {
			if (transaction.isActive()) {
				transaction.rollback();
			}
